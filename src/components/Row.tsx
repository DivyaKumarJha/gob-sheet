          ...
          <>
               <div className="flex justify-between items-center bg-white py-0.5 px-2 shadow-sm">
                    <div className="flex items-center">
                          <button
                                className="flex items-center px-3 py-1 rounded hover:bg-gray-100 space-x-1 cursor-pointer"
                                tabIndex={-1}
                                onClick={() => console.log('Tool Bar is getting clicked')}
                          >
                                <span>Tool bar</span>
               ...
               <div className="mx-7 max-w-full">
                    <div className="flex w-full h-9 border border-gray-200 rounded shadow overflow-hidden relative">
                         ...
                         <div className="h-full flex items-center px-2" style={{ width: "45%", background: "#d1d5db" }}>
                              <button className="flex items-center gap-1 bg-gray-200 border border-gray-300 rounded px-3 py-1 text-sm text-gray-500 font-medium hover:bg-gray-100 transition" onClick={() => console.log('Q3 Financial Overview clicked')}>
                         ...
                         {/* 10% white*/}
                         <button style={{ width: "10.2%", background: "#fff" }} className="h-full flex items-center justify-center border-none" onClick={() => console.log('White section clicked')}>
                         ...
                         <button style={{ width: "15.5%", background: "#a78bfa" }} className="h-full flex items-center justify-center gap-1 border-none" onClick={() => console.log('Answer a question clicked')}>
                         ...
                         <button style={{ width: "9.8%" }} className="h-full bg-orange-300 flex items-center justify-center gap-1 border-none" onClick={() => console.log('Extract clicked')}>
                         ...
                         <button style={{ width: "9.8%" }} className="h-full flex text-4xl mb-4 font-light flex items-center justify-center bg-gray-200 gap-1 border-none" onClick={() => console.log('Plus button clicked')}>
